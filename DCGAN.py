...
class Generator(nn.Module):
    def __init__(self, channels_noise, channels_img, features_g):
        ...
        self.net = nn.Sequential(
            ...
            self._block(channels_noise, features_g * 64, 4, 1, 0),  # img: 4x4
            self._block(features_g * 64, features_g * 32, 4, 2, 1), # img: 8x8
            self._block(features_g * 32, features_g * 16, 4, 2, 1), # img: 16x16
            self._block(features_g * 16, features_g * 8, 4, 2, 1),  # img: 32x32
            self._block(features_g * 8, features_g * 4, 4, 2, 1),   # img: 64x64
            self._block(features_g * 4, features_g * 2, 4, 2, 1),   # img: 128x128
